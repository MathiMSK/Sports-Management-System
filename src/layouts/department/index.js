    ...
    <DashboardLayout>
        ...
        <div style={{ minHeight: "calc(100vh - 190px)",width:"100%" ,backgroundColor:textColor}}>
          ...
          <MDBox fullwidth mt={5} sx={{ display:"flex",flexDirection:"row",margin:"15px",justifyContent:"space-between"}}>
            ...
            <MDBox sx={{ display:"flex",flexDirection:"row",margin:"5px",justifyContent:"space-between"}}>
            ...
            <MDButton variant="contained" aria-label="fingerprint" onClick={()=>setOpen1(!open1)} sx={{display:"flex",margin:"15px",fontSize:"18px"}} color={sidenavColor} >
              Course
            </MDButton>
            </MDBox>
          </MDBox>
          ...
          <>
           <MDBox fullwidth>  
            <MDBox fullwidth mt={5} sx={{display:"flex",flexDirection:"row",margin:"15px",alignItems:"baseline"}}>
              ...
              <CustomInput name={"Department Name"} placeholder={"Enter Department name"} style={{width:"300px",marginTop: '5px',}}  />
            </MDBox>
          ...
          <>
            ...
            <MDBox fullwidth mt={5} sx={{display:"flex",flexDirection:"row",margin:"15px",alignItems:"baseline"}}>
              <MDBox mt={"18px"} sx={{alignItems:"flex-start",borderRadius:"100%",boxShadow: "0 2px 8px 0 rgb(99 99 99 / 20%)",cursor:"pointer",display:"flex",
              height:"40px",justifyContent:"center",marginRight: "10px",width:"40px"}} onClick={()=>setOpen1(false)} >
                  <Arrow style={{marginLeft:"7px",marginTop:"7px"}} fontSize="medium">ArrowBackIosIcon</Arrow>
               </MDBox>
              <MDTypography variant="h4" fontWeight="medium" color="dark" mt={0} sx={{padding:0,display:"flex",alignItems:"center"  } }>
              Course Creating
              ...
              <MDBox sx={{paddingLeft:"55px"}}>
                <CustomSelect name={"Depatment"} placeholder={"Select Department "} ></CustomSelect>
              </MDBox>
              </Col>
              <Col md={6}>
              {/* <MDBox sx={{paddingLeft:"55px",padding:"55px"}}>  */}
              <CustomInput name={"Course Name"} placeholder={"Enter Course name"} style={{width:"300px",marginTop: '5px',}}  />
            {/* </MDBox> */}
            </Col>
            </Row>
            </Container>
